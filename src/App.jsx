    ...
    <div style={{ minHeight:"100vh", maxWidth:"480px", margin:"0 auto", background:C.bg, fontFamily:"'Inter',sans-serif" }}>
      ...
      <div style={{ background:C.accent, padding:"28px 20px 32px", textAlign:"center" }}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:"10px", marginBottom:"16px" }}>
          ...
          <div>
            <div style={{ fontSize:"14px", fontWeight:700, color:"#fff" }}>HealthPlan AI</div>
            <div style={{ fontSize:"10px", color:"rgba(255,255,255,0.7)", marginTop:"1px" }}>Agent Tool · InsuranceDekho</div>
          </div>
        </div>
