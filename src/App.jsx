...
const REC_TABLE = {
  ...
  surgery_treated:  { low:["Star Assure","Niva Reassure 3.0","Care Supreme"],              value:["Star Assure","Niva Reassure 3.0"],                               premium:["Aditya Birla Active One Max","Care Freedom"],                 note:"Cataract, kidney stone, rod implant etc." },
  ...
  mental:           { low:["SBI Health Alpha","Aditya Birla Active One Max"],              value:["Aditya Birla Active One Max"],                                   premium:["Care Freedom"],                                               note:"Final issuance depends on UW decision" },
