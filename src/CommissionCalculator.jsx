...
export default function CommissionCalculator() {
  ...
  async function calculate() {
    ...
    if (!form.si)      { setError("Please select sum insured."); return; }
    if (!form.age)     { setError("Please enter age.");         return; }
    if (!form.premium) { setError("Please enter net premium."); return; }
    ...
    try {
      ...
      setResult(json);
    } catch { setError("Could not calculate. Please try again."); }
    setLoading(false);
  }
            ...
            <>
              ...
              {error && (
                <div style={{ padding: "10px 12px", background: C.redLight, borderRadius: C.radiusXs,
                  fontSize: "12px", color: C.red, marginBottom: "14px" }}>
                  {error}
                </div>
              )}
        ...
        {result && (
          <div style={{ background: C.card, borderRadius: C.radius, padding: "18px",
            ...
            <div style={{ fontSize: "12px", fontWeight: 600, color: C.muted, textTransform: "uppercase",
              letterSpacing: "0.05em", marginBottom: "14px" }}>Payout Estimate</div>
